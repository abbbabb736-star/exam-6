    ...
    <footer className='footer'>
          ...
          <div className='footer__columns'>
            ...
            <div className='footer__col footer__col--social'>
              ...
              <div className='footer__socials'>
                <a
                  href='https://www.facebook.com/journeyabu'
                  target='_blank'
                ...
                <a
                  href='https://www.instagram.com/journeyabu'
                  target='_blank'
                  rel='noopener noreferrer'
                ...
                <a
                  href='https://twitter.com/journeyabu'
                  target='_blank'
                  rel='noopener noreferrer'
                  aria-label='Twitter'
                >
                ...
                <a
                  href='https://www.linkedin.com/in/journeyabu'
                  target='_blank'
                  rel='noopener noreferrer'
                  aria-label='LinkedIn'
                  className='linkedIn'
      ...
      <div className='footer__bottom'>
        <p className='footer__copy'>
          © 2021 GreenShop. All Rights Reserved. by Abduvakhid
        </p>
      </div>
    </footer>
  )
